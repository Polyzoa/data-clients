...
func TestNewClient(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := bitquery.NewClient(tt.args.apiKey, tt.args.auth); got == nil {
...
func TestClient_GetStatsData(t *testing.T) {
	type fields struct {
		...
		client        *bitquery.MockGraphqlClient
	}
	type args struct {
		chain     string
		addresses []string
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				apiKey:        "test",
				authorization: "test",
				client:        bitquery.NewMockClient([]string{TransferResponse}, []error{}),
			},
			args: args{
				chain:     "ethereum",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			bitquery.SetClient(tt.fields.client)
			c := bitquery.NewClient(tt.fields.apiKey, tt.fields.authorization)
			...
			var expected bitquery.StatsData
...
func TestClient_GetContractData(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				...
				authorization: "test",
				client:        bitquery.NewMockClient([]string{ContractResponse}, []error{}),
			},
			args: args{
				chain:     "ethereum",
				addresses: []string{"0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", "0xdac17f958d2ee523a2206206994597c13d831ec7"},
		...
		},
		{
			...
			fields: fields{
				apiKey:        "BQYAZB4gcMCjH5euRUwZQ8WinQWx5UP4",
				authorization: "test",
				client:        bitquery.NewMockClient([]string{}, []error{fmt.Errorf("test error")}),
			},
			args: args{
				chain:     "ethereum",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var expected bitquery.ContractData
			err = commons.LoadFromJson(tt.want, &expected)
			if err != nil {
...
func TestClient_GetHoldersData(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				apiKey:        "BQYAZB4gcMCjH5euRUwZQ8WinQWx5UP4",
				authorization: "test",
				client:        bitquery.NewMockClient([]string{MockHoldersResponse}, []error{}),
			},
			args: args{
				chain:   "ethereum",
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			var expected bitquery.HoldersData
			err = commons.LoadFromJson(tt.want, &expected)
			if err != nil {
				t.Errorf("GetContractData() error = %v", err)
			}
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				apiKey:        "test",
				authorization: "test",
				client:        bitquery.NewMockClient([]string{DataResponse}, []error{}),
			},
			args: args{
		...
		},
		{
			...
			fields: fields{
				apiKey:        "test",
				authorization: "test",
				client:        bitquery.NewMockClient([]string{}, []error{}),
			},
			args: args{
				address:   "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48",
				chainName: "etheereum",
		...
		},
		{
			...
			fields: fields{
				apiKey:        "test",
				authorization: "test",
				client:        bitquery.NewMockClient([]string{}, []error{errors.New("response error")}),
			},
			args: args{
				address:   "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48",
				chainName: "ethereum",
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				apiKey:        "",
				authorization: "",
				client:        bitquery.NewMockClient([]string{TransfersDataResponse}, []error{}),
			},
			args: args{
				address:   "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48",
				chainName: "ethereum",
		...
		},
		{
			...
			fields: fields{
				apiKey:        "",
				authorization: "",
				client:        bitquery.NewMockClient([]string{}, []error{errors.New("error")}),
			},
			args: args{
				address:   "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48",
				chainName: "ethereum",
	...
	tests := []struct {
	...
	}{
		{
			...
			fields: fields{
				apiKey:        "",
				authorization: "",
				client:        bitquery.NewMockClient([]string{BalanceResponse}, []error{}),
			},
			args: args{
				address:   "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48",
				chainName: "ethereum",
		...
		},
		{
			...
			fields: fields{
				apiKey:        "",
				authorization: "",
				client:        bitquery.NewMockClient([]string{BalanceResponseEmpty}, []error{}),
			},
			args: args{
				address:   "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48",
				chainName: "ethereum",
